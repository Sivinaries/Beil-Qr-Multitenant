                ...
                <div class="p-3">
                    <div class="flex">
                        ...
                        <form class="space-x-2 p-1" action="{{ route('exportOrders') }}" method="get">
                            ...
                            <select name="month" id="month" class="p-2 text-sm text-black bg-gray-100 rounded-lg">
                            ...
                            <tbody>
                                ...
                                @foreach ($history as $item)
                                    <tr class="border-2">
                                        ...
                                        <td>
                                            <h1
                                                class="p-2 w-full text-white rounded-lg text-center @if ($item->status == 'settlement') bg-green-500 @else @endif">
                                                {{ $item->status ?? 'N/A'}}
                                            </h1>
                                        </td>
                                    </tr>
