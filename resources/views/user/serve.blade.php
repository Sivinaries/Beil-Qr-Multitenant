            ...
            <div class="p-4 space-y-4">
                <div class="space-y-2">
                    ...
                    <div class="flex gap-2">
                        ...
                        <!-- Delivery Button -->
                        <form class="w-full p-2 bg-white border-2 border-gray-100 rounded-md cursor-pointer text-black text-center" action="{{ route('user-posttakeAway') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <button type="submit">
                                <div
                                    class="">
                                    <h1 class="text-center font-semibold">Take Away</h1>
                                </div>
                            </button>
                        </form>
                    </div>
