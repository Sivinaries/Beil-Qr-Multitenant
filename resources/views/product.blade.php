                                ...
                                <div class='p-2 rounded-lg relative bg-red-900 space-y-2'>
                                    <div class='space-y-2'>
                                        ...
                                        <div class='space-y-1'>
                                            ...
                                            <div class='flex space-x-2'>
                                                ...
                                                <h2 class='font-bold text-sm my-auto text-white text-center rounded-lg'>
                                    ...
                                    <div class="flex justify-between gap-2">
                                        <a href="{{ route('editproduct', ['id' => $menu->id]) }}"
                                            class="p-1 w-full text-white hover:text-black bg-blue-500 rounded-lg text-center">Edit</a>
                                        <form
                                            class="p-1 w-full text-white hover:text-black bg-red-500 rounded-lg text-center"
