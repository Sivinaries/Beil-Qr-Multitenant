        ...
        <div class="mx-auto sm:max-w-sm w-full space-y-3 p-8 bg-white rounded-3xl">
            ...
            <form method="post" action="{{ route('signup') }}" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <input class="w-full p-2 bg-gray-100 rounded-lg" type="text" name="name" required />
                </div>
                <div class="space-y-2">
                    <label for="email" class="text-black">Email</label>
                    <input class="w-full p-2 bg-gray-100 rounded-lg" type="email" name="email" required />
                </div>
                <div class='space-y-2'>
                    <label for="password" class='text-black'>Password</label>
                    <div class="password-container">
                        <input id="password" class='w-full p-2 bg-gray-100 rounded-lg pr-12' type="password"
                ...
                <div class='space-y-2'>
                    ...
                    <div class="password-container">
                        <input id="password_confirmation" class='w-full p-2 bg-gray-100 rounded-lg pr-12'
