<nav id="navbar" class="font-poppins mx-3 xl:mx-4 rounded-lg bg-white bg-opacity-90 sticky top-0 z-40 transform transition-transform duration-300">
    <div class="flex justify-around md:justify-end p-4 space-x-2 md:space-x-4">
        <div class="flex justify-end">
            <div class="my-auto">
                <form method="get" action="">
                    <div class="md:border-2 border p-1 rounded-lg md:px-4 flex">
                        <span class="">
