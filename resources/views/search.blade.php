                                        ...
                                        <table id="Tableorder" class="bg-gray-50 border-2">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="border-2">
                                                    ...
                                                    <td>
                                                        <h1 class="p-2 w-full text-white rounded-lg text-center 
                                            ...
                                            bg-gray-500 @endif">
                                                    ...
                                                    <td>
                                                        <form action="{{ route('archive', ['orderId' => $order->id]) }}" method="POST">
                                                            @csrf
                                                            <button type="submit" class="p-2 w-full text-white hover:text-black bg-blue-500 rounded-lg text-center">
                                                                Done
                                                            </button>
                                                        </form>
                                                    </td>
                                                ...
                                                <tr class="border-2">
                                                    ...
                                                    <td class="flex gap-2">
                                                        <a href="{{ route('login-qr', ['id' => $user->id]) }}">
                                                            <h1 class="p-2 w-full text-white hover:text-black bg-blue-500 rounded-lg text-center">Barcode</h1>
                                                        </a>
                                                        <form class="p-1 w-full text-white hover:text-black bg-red-500 rounded-lg text-center" method="post" action="{{ route('rmusers', ['id' => $user->id]) }}">
                                                            @csrf
                                                            @method('delete')
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="border-2">
                                                    ...
                                                    <td class="flex gap-2">
                                                        ...
                                                        <form class="p-1 w-full text-white hover:text-black bg-red-500 rounded-lg text-center" method="post" action="{{ route('deluser', ['id' => $user->id]) }}">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit">Delete</button>
                                                        </form>
                                                ...
                                                @php
                                                    ...
                                                    @foreach ($discountResults as $discount)
                                                        <tr class="border-2">
                                                            ...
                                                            <td class="">
                                                                <form class="p-1 w-full text-white hover:text-black bg-red-500 rounded-lg text-center"
                                        ...
                                        <table id="Tablehistory" class="bg-gray-50 border-2">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="border-2">
                                                    ...
                                                    <td>
                                                        <h1 class="p-2 w-full text-white rounded-lg text-center @if($history->status == 'settlement') bg-green-500 @else @endif">
                                                            {{ $history->status }}
                                                        </h1>
                                                    </td>
                                                </tr>
